...
export default function Slug() {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        if (SingleProduct) {
            const isProductInCart = cart.some((item) => item._id === SingleProduct._id)
...
<div id="single-product-page">
                <div className="single-product">
                    ...
                    <div className="single-product-details">
                        ...
                        <p>see more : <Link href={`/`}>{category?.slug}</Link></p>
                        ...
                        <div className="single-product-button">
                            ...
                            <AddToCart productInCart={productInCart} 
                            data={{ _id, price, productQuantity, title, slug, images, quantity }}  />
                        </div>
                    </div>
                </div>
            </div>
